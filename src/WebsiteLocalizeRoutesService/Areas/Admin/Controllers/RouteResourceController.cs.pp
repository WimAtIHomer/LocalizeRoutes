...
using IHomer.Services.RouteResources.Repositories;
using IHomer.Services.RouteResources;
using IHomer.Services.RouteResources.Entities;
using System.Web.UI;
using $rootnamespace$.Areas.Admin.Models;
...
namespace $rootnamespace$.Areas.Admin.Controllers
{
    ...
    {
        public virtual ActionResult Index(int id = 0, string route = Resource.ROUTE_SEPARATOR, int languageID = 0, string saveError = "")
        {
            ...
            if (resource != null)
            {
                ...
                model.ResourceType = resource.ResourceType.Value;
            ...
            else if (names.Count > 0)
            {
                ...
                model.ResourceType = names[0].ResourceType.Value;
            }
